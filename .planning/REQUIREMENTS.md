...
- [ ] **AUTH-03**: Launcher translates common XSTS/auth error codes into readable messages (e.g. "no Xbox account", "under-18 without parental linkage", "banned from Xbox Live")
