 ...
 *
 * D-11 (frozen IPC surface — Phase 1): The 5 top-level keys — auth, game,
 * settings, logs, __debug — are locked. Phase 3 Plan 03-09 extended under
 * those existing keys without adding new top-level ones.
 */
